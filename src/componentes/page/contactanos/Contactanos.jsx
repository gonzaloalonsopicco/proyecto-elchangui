...
const Contactanos = () => {
    ...
    return (
        <>
            ...
            <div className="containerRedesContactanos" >

                <div className='fondoFotoRedesContactanos'>
                    <img className='fotoRedesContactanos' src={'https://firebasestorage.googleapis.com/v0/b/el-changui.appspot.com/o/contactanos%2FPaisaje.jpg?alt=media&token=a6df557d-c500-4c11-b82e-b4bb02859a18'} alt="" />
                </div>

                <div className="fondoColorRedesContactanos">
                    <div className='divGridRedesContactanos'>

                        <Link className='divRedesContactanos' to='https://www.facebook.com/elchanguiespaciomultidiciplinario' target={'_blank'}>
                            <span>
                            ...
                            <h2 className='tituloRedesContactanos'>Facebook</h2>
                            <p className='textoRedesContactanos'>/elchanguiespaciomulti<br />disciplinario</p>
                        </Link>

                        <Link className='divRedesContactanos' to='https://www.instagram.com/elchanguiespacioagroecologico/?hl=es' target={'_blank'}>
                            <span>
                            ...
                            <h2 className='tituloRedesContactanos'>Instagram</h2>
                            <p className='textoRedesContactanos'>/elchanguiespacioa<br />groecologico</p>
                        </Link>

                        <Link className='divRedesContactanos' to='https://wa.me/5491168579724' target={'_blank'}>
                            ...
                            <h2 className='tituloRedesContactanos'> Whatsapp</h2>
                            <p className='textoRedesContactanos'>+54 9 116857 9724</p>
                        </Link>

                        <Link className='divRedesContactanos' to='https://www.google.com/maps/place/El+Changui/@-33.3123384,-66.2517383,13z/data=!4m9!1m2!2m1!1sRuta+Nacional+N%C2%B0+7+-+KM+776,5+Juana+Koslay.+San+Luis,+Argentina!3m5!1s0x95d4179435989099:0x4fe1f96ef39b8d36!8m2!3d-33.3163574!4d-66.2166126!16s%2Fg%2F11sffc2s5s' target={'_blank'}>
